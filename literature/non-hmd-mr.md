# Non-HMD Mixed Reality — Literature Review

Papers on handheld AR, projection-based MR, and alternative MR form factors.
...
**Relevance:** Historical anchor for handheld AR. Our paper revisits and modernizes this form factor for transient social contexts.
...
**Relevance:** Foundational taxonomy establishing non-HMD AR as a legitimate category. Our paper extends this with a transient-use lens.
...
**Relevance:** Establishes stationary/projection-based MR as an alternative form factor. Relevant to our stationary prototype design.
...
**Relevance:** Provides design principles that our annotated portfolio can position against — our contribution is specifically for the transient use context that this paper does not address.
...
**Relevance:** Highlights the dominant HMD-centric framing of MR interaction research — our paper explicitly addresses the gap of non-HMD alternatives.
...
**Relevance:** Establishes handheld AR's technical and UX foundations. Our contribution is the design space of *transient use* of handheld AR, not addressed by prior technical work.
...
**Relevance:** Shows that form factor choice affects social dynamics in MR — our paper's transient context is inherently social (exhibitions, museums, classrooms).

---

## Notes for Paper Positioning

- The field has HMD dominance bias; non-HMD work is older or niche
- Recent work on "spatial computing" (Apple Vision Pro, Meta Quest) is pushing HMD even harder
- Our contribution: arguing for non-HMD as the *preferred* form factor specifically for transient scenarios
- Key framing: HMDs are optimized for sustained immersion; non-HMDs are better for transient social encounters
