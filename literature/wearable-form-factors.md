# Wearable Form Factor Design — Literature Review

Papers on wearable device form factor design, body placement, and on-body interaction.
...
**Relevance:** Body placement is a core design variable. Our neck-worn prototype raises similar questions about what's visible to whom and from where.
...
**Relevance:** Directly informs the social dimension of our transient MR prototypes. Neck-worn and handheld devices carry very different social readings — this paper provides the vocabulary and framework.
...
**Relevance:** Our neck-hanging prototype directly builds on the SixthSense form factor. SixthSense showed feasibility; our work asks what the design principles for *transient* use of such devices are.
...
**Relevance:** Shows smartglasses (near-HMD) have significant social acceptability problems in public. Our work proposes alternative form factors specifically to avoid these issues.
...
**Relevance:** Represents the "always-on" paradigm that our paper explicitly challenges. Transient MR requires different design principles than always-on AR.
...
**Relevance:** Provides the evaluative framework for comparing our three non-HMD form factors (handheld, neck-worn, stationary) along wearability dimensions.
...
**Relevance:** Foundational framework for our form factor analysis. Our paper can explicitly apply Gemperle et al.'s body activity zones to justify neck vs. wrist vs. hand placement for transient MR.
