# Transient Computing — Literature Review

Papers on transient/ephemeral computing, micro-interactions, and brief device engagement.
...
**Relevance:** Provides theoretical grounding for "transient" as a distinct interaction class in wearable computing.
...
**Relevance:** Establishes the design priority of minimizing interaction latency in wearable computing — a direct parallel to our "transient" design goal.
...
**Relevance:** Empirical grounding for why transient interaction design matters. Most real-world digital touchpoints are micro-interactions, not sustained sessions.
...
**Relevance:** Validates the transient use case from an ecological validity standpoint.
...
**Relevance:** Applies to our transient MR concept: "glimpse" interactions operate at the notification/comprehension level, not deep task integration.
...
**Relevance:** Micro-interactions matter. Transient does not mean trivial — the quality of brief interactions has disproportionate experiential impact.
...
**Relevance:** Direct theoretical grounding for "transient MR" — our interfaces are designed to be calm technology that can briefly come forward when needed.

---

## Notes for Paper Positioning

- "Transient" is not the same as "glanceable" (smartwatch) — it's about the mode of MR onset/offset in public/social contexts
- Key gap to fill: prior transient computing work focuses on notifications/smartwatches; nobody has studied the design space for *transient MR specifically*
- Our contribution: defining what makes MR "transient-friendly" across form factors
