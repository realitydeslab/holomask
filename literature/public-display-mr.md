# MR in Public Spaces — Literature Review

Papers on MR in public spaces, exhibitions, museums, and situated displays.
...
**Relevance:** Our work tackles the same problem from the other direction: instead of making displays attract attention, we design MR interfaces that *invite* brief intentional engagement. Display blindness is why ambient public AR fails; transient interactive MR is the solution.
...
**Relevance:** Directly relevant to our stationary MR prototype. Establishes projection-based public MR as technically feasible.
...
**Relevance:** Museum context is central to our paper. Provides empirical data on visitor behavior with public MR installations.
...
**Relevance:** Validates the "transient" nature of museum engagement from a social science perspective. Provides vocabulary for designing around naturally brief museum encounters.
...
**Relevance:** Directly supports our "glimpse" metaphor. Brief entry points (transient MR interfaces) can drive deeper engagement — this paper provides empirical support.
...
**Relevance:** Provides the technical taxonomy within which our stationary and handheld MR prototypes sit. Our design principles extend this technical work to the UX/experiential layer.
...
**Relevance:** Empirical grounding for handheld AR in heritage/museum contexts. Shows that user acceptance depends on seamless integration with the visit — supporting our "transitional" design approach.

---

## Notes for Paper Positioning

- The museum/exhibition context is well-established in HCI but rarely studied with non-HMD MR specifically
- Key gap: prior work either studies passive displays (Müller et al.) or full immersive HMD experiences; the transient interactive MR middle ground is underexplored
- Our contribution: filling the space between ambient display and full HMD immersion
